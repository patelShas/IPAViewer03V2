...
public class UvularDecorator extends APConsDecorator {

  public UvularDecorator(IPCons baseDesc) {
    super(baseDesc);
  }

  @Override
  public String PhonemeDescriptor() {
    return "uvular " + super.PhonemeDescriptor();
  }
  ...
  public String HowToSound() {
    return super.HowToSound() + " To create the "
        ...
        + ", you need to press the back part of your tongue against your uvula. ";
  }
