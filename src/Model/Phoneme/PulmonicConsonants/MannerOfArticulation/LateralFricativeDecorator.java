...
public class LateralFricativeDecorator extends APConsDecorator {

  public LateralFricativeDecorator(IPCons baseDesc) {
    super(baseDesc);
  }

  @Override
  public String PhonemeDescriptor() {
    return "lateral fricative " + super.PhonemeDescriptor();
  }

  @Override
  public String HowToSound() {
    return super.HowToSound() + " To create this sound you force air around the "
